...
import { TCombinedAllReadIndex, TKeyTableReadIndex } from "../types/types";
import DefaultController from "./default";

class KeyTableController extends DefaultController {
    constructor(tableName: string) {
        super(tableName)
    }

    private PKSKMapper: Record<TKeyTableReadIndex, { PK: string, SK: string }> = {
        "uniqueId-Index": {
            PK: "uniqueId",
            SK: ""
        }
...
export default KeyTableController